...
std_b2b_test!(Game::Th08, "std-09.stdm", std08_rects, "th08-rects.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_strip, "th08-strip.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_loop, "th08-loop.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_instance_order, "th08-instance-order.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_jump_forward, "th08-jump-forward.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_loop_nonzero_time, "th08-loop-nonzero-time.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_loop_not_timeof, "th08-loop-not-timeof.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_nonzero_padding, "th08-nonzero-padding.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_empty_script, "th08-empty-script.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_empty_loop, "th08-empty-loop.std");
std_b2b_test!(Game::Th08, "std-09.stdm", std08_empty_loop_time, "th08-empty-loop-time.std");
std_b2b_test!(Game::Th06, "std-06.stdm", std06_general, "th06-general.std");
std_b2b_test!(Game::Th12, "std-14.stdm", std12_general, "th12-general.std");
