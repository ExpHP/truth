...
impl Format for ast::Expr {
    fn fmt<W: Write>(&self, out: &mut Formatter<W>) -> Result {
        match self {
            ...
            ast::Expr::LitInt { value: 0, format: ast::IntFormat { unsigned: _, radix: ast::IntRadix::Bool } } => out.fmt("false"),
            ast::Expr::LitInt { value: 1, format: ast::IntFormat { unsigned: _, radix: ast::IntRadix::Bool } } => out.fmt("true"),
            ast::Expr::LitInt { value, format: ast::IntFormat { unsigned: false, radix: ast::IntRadix::Bool } } => out.fmt(value),
            ast::Expr::LitInt { value, format: ast::IntFormat { unsigned: true, radix: ast::IntRadix::Bool } } => out.fmt(format_args!("{}", *value as u32)),
            ast::Expr::LitInt { value, format: ast::IntFormat { unsigned: false, radix: ast::IntRadix::Dec } } => out.fmt(value),
            ast::Expr::LitInt { value, format: ast::IntFormat { unsigned: true, radix: ast::IntRadix::Dec } } => out.fmt(format_args!("{}", *value as u32)),
            ast::Expr::LitInt { value, format: ast::IntFormat { unsigned: true, radix: ast::IntRadix::Hex } } => out.fmt(format_args!("{:#x}", value)),
            ast::Expr::LitInt { value, format: ast::IntFormat { unsigned: false, radix: ast::IntRadix::Hex } } => out.fmt(format_args!("{:#x}", SignedRadix(*value))),
            ast::Expr::LitInt { value, format: ast::IntFormat { unsigned: _, radix: ast::IntRadix::Bin } } => out.fmt(format_args!("{:#b}", value)),
